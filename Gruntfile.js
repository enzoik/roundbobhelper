module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    styles: {
      ...
      "dist/styles.css": {
        // Where to load imports from. By default it uses app/styles
    ...
    copy: {
      release: {
        files: [
          ...
          { expand: true, cwd: 'assets', src: '**', dest: 'dist/'}, // Include all the assets
        ]
      }
    },
    ...
    karma: {
      options: {
        ...
        files: [
          ...
          "node_modules/bower/chai/chai.js",
          "node_modules/bower/requirejs/require.js",
          "test/runner.js",
