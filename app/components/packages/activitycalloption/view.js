define(function(require, exports, module) {
  ...
  module.exports = Backbone.Layout.extend({
	...
	events:{
		'click .submit_callactivity' : 'submit_call',
	},
	submit_call:function(){
		...
		var coming_from = current_url.split("#activities")[0].split("/")[0].split("_")[0];
		var going_to = current_url.split("#activities")[0].split("/")[0].split("_")[1];
		var flight_class = current_url.split("#activities")[0].split("/")[0].split("_")[2];
		var departure_date = current_url.split("#activities")[0].split("/")[1].split("_")[0];
		var return_date = current_url.split("#activities")[0].split("/")[1].split("_")[1];
		var flight_type = current_url.split("#activities")[0].split("/")[1].split("_")[2];
		var no_ = current_url.split("#activities")[0].split("/")[1].split("_")[3];
