	 ...
	 afterRender: function(){
		...
		var child="";
		 ...
		 if(no_ == "s"){
			...
			adults = current_url.split("#planner")[1].split("/")[5].split("_")[1];
			child = current_url.split("#planner")[1].split("/")[5].split("_")[3];
			infants = current_url.split("#planner")[1].split("/")[5].split("_")[5];
