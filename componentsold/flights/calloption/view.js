define(function(require, exports, module) {
  ...
  module.exports = Backbone.Layout.extend({
	...
	submit_call:function(){
		...
		var client_email = document.getElementById("clients_email").value;
		...
		}else if( !filter.test(client_email) ){
			swal(
			  'Not Valid',
			  ...
			  'error'
				...
				if(last_check =="m_client" || last_check =="s_client" ){
					...
					redirectTo += '/m_mail/m_client/'+client_name+"_"+client_email+"-"+client_phone+"_call";
		...
		//#flights/(MWX) Muan International Airport, Gwangju /2017-11-14_2017-11-29_round_m/m/adlts_1_chldn_0_infnts_0/call/true_/m_mail/m_client/paa_239897876767_call
					...
					redirectTo += '/s_client/'+client_name+"_"+client_email+"-"+client_phone+"_call";
					app.router.go(redirectTo);	
				}
