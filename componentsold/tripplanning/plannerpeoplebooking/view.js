define(function(require, exports, module) {
  ...
  module.exports = Backbone.Layout.extend({
    ...
    events: {
	 ...
	 'click .get_multiple_clients_quotation_planner':'getQuotation'
    },
	getQuotation:function(){
		...
		var current_url  = window.location.href.toString();
		  ...
		  redirectTo += current_url.split("#planner")[1];
		  redirectTo += '/' + "adlts_"+no_of_adult+"_chldn_"+no_of_children+"_infants_"+no_of_rooms;
